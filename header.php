...
$con = new PDO("mysql:host=localhost;dbname=du_an_1", 'root', '');

if (isset($_POST["submit"])) {
    $str = $_POST["search"];
    $sth = $con->prepare("SELECT * FROM `san_pham` WHERE name = '$str'");
...
<?php
        ...
        echo "Không có tên sản phẩm mà bạn tìm kiếm";
    }
}
                                    ...
                                    <div class="search">
                                        <div class="search_content">
                                            <form action="" id="search_box" method="post">
                                                <input type="text" id="search_text" placeholder="Search" required title="hi" name="search">
